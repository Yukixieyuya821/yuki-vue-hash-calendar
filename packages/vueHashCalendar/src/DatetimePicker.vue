  ...
  <div class="hash-calendar"
    ...
    <div class="calendar_content"
      ...
      <div class="calendar_title"
           ...
           ref="calendarTitle">
        <slot name="action">
          <div class="calendar_title_heg">
            <div class="calendar_title_heg_box">
              <i class="calendar_title_heg_arrow"  @click="getLastYear"/>
              <span class="calendar_title_heg_text">{{checkedDate.year}}</span>
              <i class="calendar_title_heg_arrow calendar_title_heg_arrow_right" @click="getNextYear"/>
            </div>
            <div class="calendar_title_heg_box">
              <i class="calendar_title_heg_arrow" @click="getLastMonth"/>
              <span class="calendar_title_heg_text">{{formatMonth(this.checkedDate.month)}}</span>
              <i class="calendar_title_heg_arrow calendar_title_heg_arrow_right" @click="getNextMonth"/>
            </div>
          </div>
...
.calendar_title_heg {
  ...
  justify-content: space-between;
  background: #fff;
  padding-bottom: px2vw(42px);
}

.calendar_title_heg_box {
  height: px2vw(92px);
  width: px2vw(280px);
  background: #F6F6F6;
...
.calendar_title_heg_text {
  font-weight: 600;
  font-size: px2vw(30px);
  color: #281800;
  line-height: px2vw(92px);
}
.calendar_title_heg_arrow {
  display: inline-block;
  height: px2vw(33.34px);
  width: px2vw(33.34px);
  background: url('../img/back.svg') no-repeat center;
}
.calendar_title_heg_arrow_right {
